...
if __name__ == '__main__':
    ...
    adversarial = AdversarialTranslator.build(segmenter, gen_type='fpn', device='cuda:1')
    adversarial.train(train, dev, test, path=f'results/fpn/', lr=2e-4, batch_size=1, aug=True)
