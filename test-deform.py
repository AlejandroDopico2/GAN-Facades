...
if __name__ == '__main__':
    ...
    segmenter = SemanticSegmenter.load('results/segmenter', 'cuda:0')
    adversarial = AdversarialTranslator.build(segmenter, gen_type='deform', device='cuda:0')
    adversarial.train(train, dev, test, path=f'results/deform/', lr=2e-4, batch_size=1, aug=True)
