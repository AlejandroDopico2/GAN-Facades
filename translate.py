...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help="Generator type",
        choices=["base", "deform", "atnn", "link", "psp", "fpn"],
        required=True,
    )
    parser.add_argument(
        "--path",
        "-p",
        type=str,
        help="Path where to store the image translator",
        rquired=True,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--weights", action="store_true", help="Whether to use weighted loss"
    )
    parser.add_argument(
    ...
    adversarial = AdversarialTranslator.build(
        segmenter, gen_type=args.gen_type, weights=args.weights, device=args.device
    )
